...
In [[2025-08-11_buttons-to-call-animation-object-methods|buttons to call animation object methods]], we can use the *animation object* methods to control the animation. But what if we want to change the animation itself?
